 ...
 impl HTMLFormElementMethods for HTMLFormElement {
     ...
     fn RequestSubmit(&self, submitter: HTMLFormElement) -> Fallible<DOMString>{
        ...
        //step2: if step1, check if submittter is not a submit button-throw error
            ...
            let checker = submitter.is_submit_button(self);
            if checker {
                return Err(Error::Type("Type Mismatch Error".to_string()));
            }
    ...
    pub fn reset(&self, _reset_method_flag: ResetFrom) {
        ...
        for child in controls.iter() {
            ...
            match child.type_id() {
                ...
                _ => {},
>>>>>>> 0fef1bfbecd562116784958ba512ab6cd9898732
            }
 ...
 pub trait FormControl: DomObject {
     ...
     fn is_submit_button(&self, submitter: HTMLFormElement) -> bool{
        
        let typeCheck = submitter.get_attribute("type");
